...
class EditTransaction extends StatefulWidget {
  ...
  ///CONSTRUCTOR
  EditTransaction({ Key? key, required this.transactionRecord }) : super(key: key);
...
class _EditTransactionState extends State<EditTransaction> {
  ...
  void initState() {
    ...
    var cardID = cards.indexOf(widget.transactionRecord.cardNumber.replaceAll(RegExp(r'\d(?!\d{0,4}$)'), '*'));
                ...
                children: <Widget>[
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      AdaptiveFlatButton('Choose Date', _presentDatePicker, (_type == 'expense') ? Color(0xFF768cfc) : Color(0xFF34ccfd),)
                      ],
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: new DropdownButton<String>(
                      ...
                      onChanged: (String ?val) { print("Current value: $val"); setState(() {
                        _selectedCard = val!;
                      }); },
                  ...
                  Container(
                    ...
                    child: FullButton(
                      ...
                      handler: () async {
                        ...
                        print("DISPLAY ICON --> ${_selectedCategory}");
                        ...
                        if(_formKey.currentState!.validate()){
                          ...
                          entry = alertOverlay( 
                            AlertNotification(text: 'Transaction updated', color: Colors.deepPurple), tapHandler: () {  }
                          );
                          ...
                          entry = alertOverlay( 
                            AlertNotification(text: 'Cannot add transaction with invalid fields!', color: Colors.red.shade400),
                            tapHandler: (){
                              entry?.remove();
                              entry = null;
                            }
                              ...
                              onPressed: () async { 
                                ...
                                entry = OverlayEntry(
                                  builder: (BuildContext context) {
                                    return GestureDetector(
                                      onTap: () => null,
                                      child: AlertNotification(text: 'Transaction deleted', color: Colors.deepPurple,)
                                    );
                                  }
                                );
                            ...
                            showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  ...
                                  content: Text("Are you sure you want to delete this transaction?.", textAlign: TextAlign.start,),
                                  actions: [
                                    cancelButton,
                                    deleteButton,
                                  ],
